...
import { doc, setDoc, Timestamp, query, collection, getDocs, updateDoc, increment } from "firebase/firestore"
...
const addStudent = async () => {
    ...
    courseRegis.value.forEach(async (course) => {
        await updateDoc(doc(db,"courses",course),{
